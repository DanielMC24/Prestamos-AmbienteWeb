<?php include_once '../ajax/RegistroClienteController.php' ?>
    ...
    <div class="col-lg-12">
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                <h2 class="box-title">Clientes <button class="btn btn-success" id="btnagregar"
                        onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button></h2>
            </header>
                ...
                <form action="" method="POST">
                    <div class="row">
                        <div class="form-group col-md-5 col-sm-8 col-xs-12">
                            ...
                            <input type="text" name="txtIdentificacion" id="txtIdentificacion" class="form-control"
                                placeholder="Identificacion" maxlength="20" required>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-md-8 col-sm-8 col-xs-12">
                            ...
                            <input type="text" name="txtDirrecion" id="txtDirrecion" class="form-control"
                    ...
                    <div class="form-group col-xs-12">
                        <button class="btn btn-primary" type="submit" name="btnGuardar" id="btnGuardar"><i
                                class="fa fa-save"></i>
                            Guardar</button>
